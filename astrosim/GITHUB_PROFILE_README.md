...
astrosim/
├── physics/
│   ├── constants.py          50+ IAU 2012 / CODATA 2018 constants
│   ├── gravity.py            Newton, Hill sphere, Roche limit, GW power
│   └── orbital_mechanics.py  Kepler, vis-viva, Hohmann, Tsiolkovsky
└── simulation/
    └── orbit_simulator.py    N-body RK4 + symplectic Leapfrog integrators
```
